...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(dady..":NameBot:")
...
var = 'مطور اساسي ' 
elseif  UserID == 1153223737 then
var =  'مطور السورس'
elseif  UserID == 1710896172 then
var =  'مطور السورس'
elseif redis:sismember(dady..':SUDO_BOT:',UserID) then
var = 'مطور البوت ' 
elseif redis:sismember(dady..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(dady..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء ' 
elseif redis:sismember(dady..'owners:'..ChatID,UserID) then
var = 'مدير البوت ' 
elseif redis:sismember(dady..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت ' 
elseif redis:sismember(dady..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ' 
else
var = 'فقط عضو ' 
end
...
if msg.edited then
redis:incr(dady..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(dady..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(dady..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(dady..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(dady..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(dady..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(dady..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(dady..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(dady..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(dady..':SUDO_BOT:')
message = '-  قائمه الـمـطـوريـن : \n\n`- مطور اساسي`**\n'..SUDO_USER..' ⇽ ❪' ..SUDO_ID.. '❫\n*———————— *\n'
if #list==0 then  message = message.."* - لا يوجد مطورين حاليا \n⋆*"
else
for k,v in pairs(list) do
local info = redis:hgetall(dady..'username:'..v)
local count = redis:scard(dady..'mtwr_count'..v)
...
local monsha = redis:smembers(dady..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————  \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(dady..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(dady..'admins:'..msg.chat_id_)
...
local list = redis:smembers(dady..'whitelist:'..msg.chat_id_)
...
if redis:sismember(dady..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(dady..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(dady..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(dady..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(dady..'gban_users')
...
local list = redis:smembers(dady..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(dady..':Filter_Word:'..msg.chat_id_,word) then 
return  "- **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع↯" 
else
redis:sadd(dady..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(dady..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(dady..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(dady..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(dady..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(dady..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(dady..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(dady..'group:ids')
message = '- **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(dady..'group:name'..v)
if info then 
...
redis:del(
dady..'group:add'..id_group,
dady..'lock_link'..id_group, 
dady..'lock_id'..id_group,
dady..'lock_spam'..id_group, 
dady..'lock_webpage'..id_group,
dady..'lock_markdown'..id_group,
dady..'lock_flood'..id_group,
dady..'lock_bots'..id_group,
dady..'mute_forward'..id_group,
dady..'mute_contact'..id_group,
dady..'mute_location'..id_group,
dady..'mute_document'..id_group,
dady..'mute_keyboard'..id_group,
dady..'mute_game'..id_group,
dady..'mute_inline'..id_group,
dady..'lock_username'..id_group,
dady..'num_msg_dady'..id_group,
dady..'replay'..id_group
)
redis:srem(dady..'group:ids',id_group)
end
...
redis:hset(dady..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(dady..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(dady..'group:add'..msg.chat_id_) then  return '⋆**المجموعه بالتأكيد تم تفعيلها' end
...
redis:setex(dady..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(dady..':addnumberusers') or 0)
...
local lock_service = redis:get(dady..'lock_service')
if lock_service then 
sendMsg(msg.chat_id_,msg.id_,'⋆* تم تفعيل المجموعه بنجاح .  𖠭 . \n*⋆ ورفع كل المشرفين\n [ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙴𝙻 𖣫 ](t.me/UU_dady)')
else
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(dady..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(dady..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
dady..'group:add'..msg.chat_id_,true,
dady..'lock_link'..msg.chat_id_,true, 
dady..'lock_id'..msg.chat_id_,true,
dady..'lock_spam'..msg.chat_id_,true,
dady..'lock_webpage'..msg.chat_id_,true,
dady..'lock_markdown'..msg.chat_id_,true,
dady..'lock_flood'..msg.chat_id_,true,
dady..'lock_bots'..msg.chat_id_,true,
dady..'mute_forward'..msg.chat_id_,true,
dady..'mute_contact'..msg.chat_id_,true,
dady..'mute_location'..msg.chat_id_,true,
dady..'mute_document'..msg.chat_id_,true,
dady..'mute_keyboard'..msg.chat_id_,true,
dady..'mute_game'..msg.chat_id_,true,
dady..'mute_inline'..msg.chat_id_,true,
dady..'lock_username'..msg.chat_id_,true,
dady..'num_msg_dady'..msg.chat_id_,5, 
dady..'replay'..msg.chat_id_,true
)

redis:sadd(dady..'group:ids',msg.chat_id_) 
redis:sadd(dady..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(dady..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(dady..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(dady..'group:add'..msg.chat_id_) then return '- ** المجموعه بالتأكيد تم تعطيلها' end  
...
if redis:sismember(dady..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء  \n↯',17,USERCAR) 
end
redis:hset(dady..'username:'..UserID,'username',Resolv)
redis:sadd(dady..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء في البوت \n↯',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(dady..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء \n↯',17,USERCAR) 
end
redis:srem(dady..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(dady..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء اساسي \n↯',17,USERCAR) 
end
redis:hset(dady..'username:'..UserID,'username',Resolv)
redis:sadd(dady..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء اساسي في البوت \n↯',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(dady..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء اساسي\n↯',17,USERCAR) 
end
redis:srem(dady..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(dady..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد عضو مميز \n↯',17,USERCAR) 
end
redis:hset(dady..'username:'..UserID, 'username', Resolv)
redis:sadd(dady..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح عضو مميز \n↯',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(dady..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس عضو مميز \n↯',17,USERCAR) 
end
redis:srem(dady..'whitelist:'..ChatID,UserID)
...
if redis:sismember(dady..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد مدير \n↯',17,USERCAR) 
end
redis:hset(dady..'username:'..UserID, 'username', Resolv)
redis:sadd(dady..'owners:'..ChatID,UserID)
...
if redis:sismember(dady..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ادمن \n↯',17,USERCAR) 
end
redis:hset(dady..'username:'..UserID, 'username', Resolv)
redis:sadd(dady..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح ادمن \n↯',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(dady..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مدير \n↯',17,USERCAR) 
end
redis:srem(dady..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم تنزيله من المدير  \n↯',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(dady..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس ادمن \n↯',17,USERCAR) 
end
redis:srem(dady..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(dady..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(dady..'username:'..UserID, 'username', Resolv)
redis:sadd(dady..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم حظره  \n↯',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(dady..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتأكيد الغاء حظره  \n↯',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء حظره \n↯',17,USERCAR) 
end
redis:srem(dady..'banned:'..ChatID,UserID)
...
if redis:sismember(dady..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتأكيد كتمه  \n↯',17,USERCAR) 
end
redis:hset(dady..'username:'..UserID, 'username', Resolv)
redis:sadd(dady..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم كتمه \n↯',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(dady..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتاكيد الغاء كتمه  \n↯',17,USERCAR) 
end
redis:srem(dady..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء كتمه  \n↯',17,USERCAR) 
end
...
redis:hset(dady..'username:'..UserID, 'username',Resolv)
redis:sadd(dady..'gban_users',UserID)
...
redis:srem(dady..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء حظره العام \n↯',17,USERCAR) 
end
...
if redis:sismember(dady..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد مطور \n↯',17,USERCAR) 
end
redis:hset(dady..'username:'..UserID, 'username', Resolv)
redis:sadd(dady..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم ترقيته ليصبح مطور \n↯',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(dady..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مطور \n↯',17,USERCAR) 
end
redis:srem(dady..':SUDO_BOT:',UserID)
...
redis:hset(dady..'username:'..UserID, 'username', UserName)
redis:sadd(dady..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'- **العضو ⇽ ❪ '..UserName..' ❫\n- **الايدي ⇽ ❪ `'..UserID..'` ❫\n- **تمت ترقيته ليصبح منشىء في البوت \n↯')
end
...
return sendMsg(ChatID,MsgID,
  '⋆ ℕᎯℳ℮ » '..FlterName(data.title_,30)..'\n'
..'⋆ Ꮠⅅ » {`'..UserID..'`} \n'
..' ⋆ 𝓤𝓢𝓔 »  '..UserName..'\n'
..'⋆ ᏕƬᎯ » '..Getrtba(UserID,ChatID)..'\n'
..'\n'
..' ')
end
...
if redis:sismember(dady..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'- **العضو ⇽ ❪ '..UserName..' ❫\n- **الايدي ⇽ ❪ `'..UserID..'` ❫\n- **تم بالتأكيد حظره \n↯') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(dady..'username:'..UserID, 'username', Resolv)
redis:sadd(dady..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم تقييد آلعضـو بنجآح \n↯',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(dady..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم فگ تقييد آلعضـو بنجآح \n↯',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(dady..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(dady..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'-**العضو ⇽ '..USERNAME..' \n-** الايدي ⇽ (`'..UserID..'`)\n-**انه بالتأكيد ليس مطور \n✓') end
redis:srem(dady..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n-الايدي ⇽ ❪ '..UserID..' ❫\n-تم تنزيله من المطورين \n↯',17,USERCAR) 
end
...
if redis:get(dady..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(dady..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(dady..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(dady..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*-* اعدادات المجموعه : \n"
.."\n1-╿التعديل ⇽ "..(redis:get(dady..'lock_edit'..msg.chat_id_) or 'false')
.."\n2-│الروابط ⇽ "..(redis:get(dady..'lock_link'..msg.chat_id_) or 'false')
.."\n3-│التاك ⇽ "..(redis:get(dady..'lock_tag'..msg.chat_id_) or 'false')
.."\n4-│المعرفات ⇽ "..(redis:get(dady..'lock_username'..msg.chat_id_) or 'false')
.."\n5-│التكرار ⇽ "..(redis:get(dady..'lock_flood'..msg.chat_id_) or 'false')
.."\n6-│الكلايش ⇽ "..(redis:get(dady..'lock_spam'..msg.chat_id_) or 'false')
.."\n7-│الويب ⇽ "..(redis:get(dady..'lock_webpage'..msg.chat_id_) or 'false')
.."\n8-│الماركدوان ⇽ "..(redis:get(dady..'lock_markdown'..msg.chat_id_) or 'false')
.."\n9-│بالطرد البوتات ⇽ "..(redis:get(dady..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n10-│البوتات ⇽ "..(redis:get(dady..'lock_bots'..msg.chat_id_) or 'false')
.."\n11-│عدد التكرار ⇽ "..(redis:get(dady..'num_msg_dady'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n-│اعدادات الوسائط :\n"
.."\n*1-│*المتحركه ⇽ "..(redis:get(dady..'mute_gif'..msg.chat_id_) or 'false')
.."\n2-│الدردشه ⇽ "..(redis:get(dady..'mute_text'..msg.chat_id_) or 'false')
.."\n3-│الانلاين ⇽ "..(redis:get(dady..'mute_inline'..msg.chat_id_) or 'false')
.."\n4-│الالعاب ⇽"..(redis:get(dady..'mute_game'..msg.chat_id_) or 'false')
.."\n5-│الصور ⇽ "..(redis:get(dady..'mute_photo'..msg.chat_id_) or 'false')
.."\n6-│الفيديو ⇽ "..(redis:get(dady..'mute_video'..msg.chat_id_) or 'false')
.."\n7-│البصمات ⇽ "..(redis:get(dady..'mute_audio'..msg.chat_id_) or 'false')
.."\n8-│الصوت ⇽ "..(redis:get(dady..'mute_voice'..msg.chat_id_) or 'false')
.."\n9-│الملصقات ⇽ "..(redis:get(dady..'mute_sticker'..msg.chat_id_) or 'false')
.."\n10-│الجهات ⇽ "..(redis:get(dady..'mute_contact'..msg.chat_id_) or 'false')
.."\n11-│التوجيه ⇽ "..(redis:get(dady..'mute_forward'..msg.chat_id_) or 'false')
.."\n12-│الموقع ⇽ "..(redis:get(dady..'mute_location'..msg.chat_id_) or 'false')
.."\n13-│الملفات ⇽ "..(redis:get(dady..'mute_document'..msg.chat_id_) or 'false')
.."\n14-│الاشعارات ⇽ "..(redis:get(dady..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n15-│الكيبورد ⇽ "..(redis:get(dady..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*-│*اعدادات اخرى : "
.."\n\n*1-│*الترحيب ⇽ "..welcomex
.."\n*2-│*الردود ⇽ "..replayx
...
list_settings = "-`اعدادات المجموعه :` "
.."\n\n-1╿التاك ⇽ "..(redis:get(dady..'lock_tag'..msg.chat_id_) or 'false')
.."\n-2|المعرفات ⇽ "..(redis:get(dady..'lock_username'..msg.chat_id_) or 'false')
.."\n-3|التعديل ⇽ "..(redis:get(dady..'lock_edit'..msg.chat_id_) or 'false')
.."\n-4|الروابط ⇽ "..(redis:get(dady..'lock_link'..msg.chat_id_) or 'false')
.."\n-5|التكرار ⇽ "..(redis:get(dady..'lock_flood'..msg.chat_id_) or 'false')
.."\n-6|الكلايش ⇽ "..(redis:get(dady..'lock_spam'..msg.chat_id_) or 'false')
.."\n-7|الويب ⇽ "..(redis:get(dady..'lock_webpage'..msg.chat_id_) or 'false')
.."\n-8|الماركدوان ⇽ "..(redis:get(dady..'lock_markdown'..msg.chat_id_) or 'false')
.."\n-9|البوتات بالطرد ⇽ "..(redis:get(dady..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n-10|البوتات ⇽ "..(redis:get(dady..'lock_bots'..msg.chat_id_) or 'false')
.."\n-11|عدد التكرار ⇽ "..(redis:get(dady..'num_msg_dady'..msg.chat_id_) or 'false')
.."\n—————————\n*-*اعدادات التقـييد :\n"
.."\n*-1|*التقييد بالتوجيه ⇽ "..(redis:get(dady..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*-2|*التقييد بالصور ⇽ "..(redis:get(dady..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*-3|*التقييد بالروابط ⇽ "..(redis:get(dady..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*-4|*التقييد بالمتحركه ⇽ "..(redis:get(dady..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*-5|*التقييد الفيديو ⇽ "..(redis:get(dady..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')

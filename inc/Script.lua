...
if MsgText[1] == "id" or MsgText[1]:lower() == "ايدي دادي" then
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/mohamed2512000/dadyfile/master/GetVersion.txt' ) or 0
...
return '⋆اصدار سورس دادي : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'⋆** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس دادي يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : دادي](https://t.me/Source_AdrYan)' ,nil,inline,msg.id_)
return false
end
...
elseif Text== "دادي" or Text== "جوجل" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس دادي↯](https://t.me/google75)")

...
if MsgText[1] == "id" or MsgText[1]:lower() == "ايدي Adryan" then
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/AhmedAdryan2/Adryanfile/master/GetVersion.txt' ) or 0
...
return '⋆اصدار سورس Adryan : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'⋆** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس Adryan يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/Source_AdrYan"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : Adryan](https://t.me/Source_AdrYan)' ,nil,inline,msg.id_)
return false
end
...
♪• م4 «» اوامر الخدمه 
♪• م5 «»  اوامر المطور
♪• .[قـنـاه الـسـورس](t.me/Source_AdrYan) 
♪• [ مـطـور الـسـورس ](t.me/AhmedBeh0)
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
...
local keyboard = {}
keyboard.inline_keyboard = {
{{text = '- 𝘈𝐃𝐑𝐘𝐀𝐍 𖠲 .',url="https://t.me/AhmedBeh0"}},
{{text = '- 𝐬𝐨𝐮𝐫𝐜𝐞 .',url="https://t.me/Source_AdrYan"}},
}   
...
elseif Text== "Adryan" or Text== "جوجل" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس ↯](https://t.me/google75)")
elseif Text== "مطور السورس" or Text== "احمد" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس  💌↯](https://t.me/AhmedBeh0)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/Source_AdrYan) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/Source_AdrYan)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/Source_AdrYan)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/Source_AdrYan)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/Source_AdrYan)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/Source_AdrYan) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/Source_AdrYan)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Source_AdrYan)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Source_AdrYan)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Source_AdrYan)")
